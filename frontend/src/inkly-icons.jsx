/* SVG icon sprite — all icons referenced by name string */

export const I = ({ d, s = 16, fill = "none", stroke = "currentColor", w = 1.6, children }) => (
...
export const Icons = {
  ...
  Trash:  (p) => <I s={p.s||15}><path d="M4 7h16M9 7V5a1 1 0 0 1 1-1h4a1 1 0 0 1 1 1v2M6 7l1 13a1 1 0 0 0 1 1h8a1 1 0 0 0 1-1l1-13M10 11v6M14 11v6"/></I>,
  Shield: (p) => <I s={p.s||15}><path d="M12 3 5 6v5c0 4.5 3 7.5 7 9 4-1.5 7-4.5 7-9V6l-7-3Z"/></I>,
  Camera: (p) => <I s={p.s||15}><path d="M4 8h3l1.5-2h7L17 8h3a1 1 0 0 1 1 1v9a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V9a1 1 0 0 1 1-1Z"/><circle cx="12" cy="13" r="3.2"/></I>,
  Pencil: (p) => <I s={p.s||14}><path d="M16.5 4.5 19.5 7.5M4 20l1-4 11-11 3 3-11 11-4 1Z"/></I>,
  Swap:   (p) => <I s={p.s||15}><path d="M7 4 4 7l3 3M4 7h13M17 20l3-3-3-3M20 17H7"/></I>,
  Key:    (p) => <I s={p.s||15}><circle cx="8" cy="15" r="4"/><path d="M11 12 20 3M17 6l2 2M14 9l2 2"/></I>,
  Device: (p) => <I s={p.s||15}><rect x="3" y="5" width="13" height="14" rx="2"/><rect x="17" y="9" width="4" height="10" rx="1"/></I>,
  G: () => (
