...
export function Login({ onSignIn, theme, onTheme, onPushToast }) {
  const navigate = useNavigate();
  const [email, setEmail] = useState("avery@inkly.team");
  ...
  function submit(e) {
    ...
    setLoading(true);
    INKLY_API.login(email, pw, remember)
      .then(data => {
        setLoading(false);
        onSignIn(data);
      })
      ...
      <div className="login__right">
        ...
        <form className="auth" onSubmit={submit} noValidate>
          ...
          <div className="auth__oauth">
            <button type="button" className="oauth-btn" onClick={() => onPushToast?.("Google SSO coming soon")}><Icons.G/> Continue with Google</button>
            <button type="button" className="oauth-btn" onClick={() => onPushToast?.("Microsoft SSO coming soon")}><Icons.Microsoft/> Continue with Microsoft</button>
          </div>
          ...
          <label className="field">
            <span className="field__label">
              Password
              <a href="#" onClick={(e) => { e.preventDefault(); onPushToast?.("Password reset link sent to your email"); }}>Forgot password?</a>
            </span>
          ...
          <div className="auth__footer">
            New to Inkly?{" "}
            <a href="#" onClick={e => { e.preventDefault(); navigate("/signup"); }}>Create a workspace</a>
          </div>
        </form>
      </div>
    </div>
